...
const AboutUs = () => {
  return (
    <div className='mt-10'>
        <div className="min-h-screen px-4 py-16 bg-white text-gray-800">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-green-900 mb-6 text-center">About StoryMint</h1>

        <p className="text-lg mb-6 leading-relaxed">
          Welcome to <span className="font-semibold text-green-900">StoryMint</span>, your ultimate online platform for book lovers!  
        ...
        <h2 className="text-2xl font-semibold text-green-900 mb-4">Our Values</h2>
        ...
        <h2 className="text-2xl font-semibold text-green-900 mb-4">Get in Touch</h2>
        <p className="text-lg mb-6 leading-relaxed">
          Have questions or feedback? Feel free to reach out to us at <a href="mailto:support@storymint.com" className="text-green-900 underline">support@storymint.com</a>.  
