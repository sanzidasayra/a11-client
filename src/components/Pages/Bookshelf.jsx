...
const Bookshelf = () => {
  ...
  return (
    <div className="mt-15 rounded-3xl p-6 min-h-screen w-11/12 sm:w-10/12 md:w-10/12 lg:w-8/12 mx-auto 
      ...
      <h1 className="text-3xl font-bold text-center text-green-800 dark:text-gray-100 mb-5">
        Bookshelf
      </h1>

      {selectedCategory && (
        <h3 className="text-center text-lg font-semibold text-green-700 dark:text-green-300 mb-4">
      ...
      {currentBooks.length === 0 ? (
        <p className="text-center text-gray-500 dark:text-gray-400 text-xl">
          No books available based on your filter.
        </p>
      ) : (
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md border 
              ${currentPage === 1 
                ...
                : 'text-gray-700 border-gray-700 hover:bg-gray-700 hover:text-white dark:text-gray-200 dark:border-gray-500 dark:hover:bg-gray-600'}`}
          >
            Prev
          </button>
